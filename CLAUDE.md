...
- **Только Windows.** Весь серверный код на Winsock2: `SOCKET`, `INVALID_SOCKET`, `closesocket`, `WSAGetLastError`, `WinsockGuard`. Портирование на Linux ещё не сделано.
...
1. **Портирование сервера на Linux** — слой абстракции над сокетами в `common`, `#ifdef _WIN32`. Делать до конфигов и TLS, иначе придётся переделывать дважды.
